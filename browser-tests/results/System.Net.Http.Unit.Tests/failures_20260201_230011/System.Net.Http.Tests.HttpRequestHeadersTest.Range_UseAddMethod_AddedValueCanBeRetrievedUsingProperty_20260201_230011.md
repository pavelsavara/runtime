# Test Failure: System.Net.Http.Tests.HttpRequestHeadersTest.Range_UseAddMethod_AddedValueCanBeRetrievedUsingProperty

**Timestamp:** 20260201_230011

**Full Name:** `System.Net.Http.Tests.HttpRequestHeadersTest.Range_UseAddMethod_AddedValueCanBeRetrievedUsingProperty`
...
```
Assert.Equal() Failure: Exception thrown during comparison\nExpected: custom=1-2, -4\nActual:   custom=1-2, -4\n---- System.BadImageFormatException : An attempt was made to load a program with an incorrect format.\n (0x8007000B)
```

**Stack Trace:**

```
at System.Net.Http.Tests.HttpRequestHeadersTest.Range_UseAddMethod_AddedValueCanBeRetrievedUsingProperty()
