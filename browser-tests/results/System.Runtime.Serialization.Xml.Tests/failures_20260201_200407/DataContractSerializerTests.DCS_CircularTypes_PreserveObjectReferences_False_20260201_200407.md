# Test Failure: DataContractSerializerTests.DCS_CircularTypes_PreserveObjectReferences_False

**Timestamp:** 20260201_200407

**Full Name:** `DataContractSerializerTests.DCS_CircularTypes_PreserveObjectReferences_False`
...
at System.Signature.Init(ObjectHandleOnStack _this, Void* pCorSig, Int32 cCorSig, RuntimeFieldHandleInternal fieldHandle, RuntimeMethodHandleInternal methodHandle)
   ...
   at WriteTypeWithListOfReferenceChildrenToXml(XmlWriterDelegator, Object, XmlObjectSerializerWriteContext, ClassDataContract)
   ...
   at DataContractSerializerTests.DCS_CircularTypes_PreserveObjectReferences_False()
