# Test Failure: DataContractSerializerTests.DCS_TypeWithKnownTypeAttributeAndListOfInterfaceMember

**Timestamp:** 20260201_200407

**Full Name:** `DataContractSerializerTests.DCS_TypeWithKnownTypeAttributeAndListOfInterfaceMember`
...
at System.Signature.Init(ObjectHandleOnStack _this, Void* pCorSig, Int32 cCorSig, RuntimeFieldHandleInternal fieldHandle, RuntimeMethodHandleInternal methodHandle)
   ...
   at WriteTypeWithKnownTypeAttributeAndListOfInterfaceMemberToXml(XmlWriterDelegator, Object, XmlObjectSerializerWriteContext, ClassDataContract)
   ...
   at DataContractSerializerTests.DCS_TypeWithKnownTypeAttributeAndListOfInterfaceMember()
