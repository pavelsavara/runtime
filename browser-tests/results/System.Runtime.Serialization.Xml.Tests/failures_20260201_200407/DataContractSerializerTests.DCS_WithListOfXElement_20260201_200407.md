# Test Failure: DataContractSerializerTests.DCS_WithListOfXElement

**Timestamp:** 20260201_200407

**Full Name:** `DataContractSerializerTests.DCS_WithListOfXElement`
...
at System.Signature.Init(ObjectHandleOnStack _this, Void* pCorSig, Int32 cCorSig, RuntimeFieldHandleInternal fieldHandle, RuntimeMethodHandleInternal methodHandle)
   ...
   at WriteWithListOfXElementToXml(XmlWriterDelegator, Object, XmlObjectSerializerWriteContext, ClassDataContract)
   ...
   at DataContractSerializerTests.DCS_WithListOfXElement()
