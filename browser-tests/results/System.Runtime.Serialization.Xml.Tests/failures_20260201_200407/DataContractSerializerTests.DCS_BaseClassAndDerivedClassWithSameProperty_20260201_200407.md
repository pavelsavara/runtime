# Test Failure: DataContractSerializerTests.DCS_BaseClassAndDerivedClassWithSameProperty

**Timestamp:** 20260201_200407

**Full Name:** `DataContractSerializerTests.DCS_BaseClassAndDerivedClassWithSameProperty`
...
at System.Signature.Init(ObjectHandleOnStack _this, Void* pCorSig, Int32 cCorSig, RuntimeFieldHandleInternal fieldHandle, RuntimeMethodHandleInternal methodHandle)
   ...
   at WriteDerivedClassWithSamePropertyToXml(XmlWriterDelegator, Object, XmlObjectSerializerWriteContext, ClassDataContract)
   ...
   at DataContractSerializerTests.DCS_BaseClassAndDerivedClassWithSameProperty()
