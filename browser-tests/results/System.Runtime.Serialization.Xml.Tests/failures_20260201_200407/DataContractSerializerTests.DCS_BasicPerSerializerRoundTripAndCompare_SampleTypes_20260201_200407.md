# Test Failure: DataContractSerializerTests.DCS_BasicPerSerializerRoundTripAndCompare_SampleTypes

**Timestamp:** 20260201_200407

**Full Name:** `DataContractSerializerTests.DCS_BasicPerSerializerRoundTripAndCompare_SampleTypes`
...
at System.Signature.Init(ObjectHandleOnStack _this, Void* pCorSig, Int32 cCorSig, RuntimeFieldHandleInternal fieldHandle, RuntimeMethodHandleInternal methodHandle)
   ...
   at WriteDCListPrivateTContainer2ToXml(XmlWriterDelegator, Object, XmlObjectSerializerWriteContext, ClassDataContract)
   ...
   at DataContractSerializerTests.DCS_BasicPerSerializerRoundTripAndCompare_SampleTypes()
