# Test Failure: DataContractSerializerTests.DCS_BasicPerSerializerRoundTripAndCompare_EnumStruct

**Timestamp:** 20260201_200407

**Full Name:** `DataContractSerializerTests.DCS_BasicPerSerializerRoundTripAndCompare_EnumStruct`
...
at System.Signature.Init(ObjectHandleOnStack _this, Void* pCorSig, Int32 cCorSig, RuntimeFieldHandleInternal fieldHandle, RuntimeMethodHandleInternal methodHandle)
   ...
   at WriteListContainerToXml(XmlWriterDelegator, Object, XmlObjectSerializerWriteContext, ClassDataContract)
   ...
   at DataContractSerializerTests.DCS_BasicPerSerializerRoundTripAndCompare_EnumStruct()
