# Test Failure: DataContractSerializerTests.DCS_ListGenericMembers

**Timestamp:** 20260201_200407

**Full Name:** `DataContractSerializerTests.DCS_ListGenericMembers`
...
at System.Signature.Init(ObjectHandleOnStack _this, Void* pCorSig, Int32 cCorSig, RuntimeFieldHandleInternal fieldHandle, RuntimeMethodHandleInternal methodHandle)
   ...
   at WriteTypeWithListGenericMembersToXml(XmlWriterDelegator, Object, XmlObjectSerializerWriteContext, ClassDataContract)
   ...
   at DataContractSerializerTests.DCS_ListGenericMembers()
