...
:: Follows the same pattern as src\native\corehost\build.cmd.
...
echo Configuring monohost native components
echo.
...
if %__IntermediatesDir% == "" (
    set "__IntermediatesDir=%__objDir%\%__TargetRid%.%CMAKE_BUILD_TYPE%\monohost"
)
if %__Ninja% == 0 (
...
echo Commencing build of monohost native components
...
echo Done building monohost native components
...
:Failure
:: Build failed
echo Failed to generate monohost native component build project!
exit /b 1
